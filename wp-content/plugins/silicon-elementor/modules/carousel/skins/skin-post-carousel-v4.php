 ...
 * Skin Post Carousel
 */
class Skin_Post_Carousel_V4 extends Skin_Base {
	...
	public function get_title() {
		return esc_html__( 'Post Carousel v4', 'silicon-elementor' );
	}
	...
	protected function _register_controls_actions() {
		...
		add_action( 'elementor/element/sn-post-carousel/section_slides_style/after_section_end', [ $this, 'update_section_slides_style_v4' ], 10, 1 );
	}
	...
	public function update_layout_controls( $widget ) {
		...
		foreach ( $controls as $control ) {
			...
			$widget->update_control(
				...
				[
					'condition' => [
						'_skin!' => array( 'post-carousel-v3', 'post-carousel-v4' ),
					],
				]
			);
	 ...
	 * @return void
	 */
	public function update_section_slides_style_v4( Widget_Base $widget ) {
		$this->parent = $widget;
	...
	protected function print_slider( array $settings = null ) {
		...
		while ( $wp_query->have_posts() ) {
			...
			get_template_part( 'templates/contents/loop-post', 'slider' );
			?>
			</div>
			<?php
			$element_key++;
